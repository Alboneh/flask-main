...
class ProductAdapterSeven(private val listProduct: List<ProductResponse>) :
    RecyclerView.Adapter<ProductAdapterSeven.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductAdapterSeven.ListViewHolder {
        val binding =
            ItemCardviewDetailBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ListViewHolder(binding)
    }

    override fun onBindViewHolder(holder: ProductAdapterSeven.ListViewHolder, position: Int) {
